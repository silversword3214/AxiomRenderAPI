...
public final class RenderPipelines {
    ...
    static {
        ...
        BUILDERS.add(new PipelineBuilder(DYNAMIC_TRANSFORMS)
                ...
                .withVertexShader(id("shaders/world_colored_2d.vert")) // make sure this shader exists
                .withFragmentShader(id("shaders/world_colored.frag"))
                .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                .withDepthWrite(false)
                .withBlend(BlendFunction.TRANSLUCENT)
        ...
        BUILDERS.add(new PipelineBuilder(DYNAMIC_TRANSFORMS)
                ...
                .withVertexShader(id("shaders/world_colored_2d.vert"))
                .withFragmentShader(id("shaders/world_colored.frag"))
                .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
                .withDepthWrite(false)
                .withBlend(BlendFunction.TRANSLUCENT)
    ...
    private static Identifier id(String path) {
        return Identifier.fromNamespaceAndPath("axiomrenderapi", path);
    }
